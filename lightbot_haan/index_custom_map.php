...
if($_REQUEST["map_data"]!=null) {
$stripped_request=stripslashes($_REQUEST["map_data"]); //jon 20150712 added (because mochahost adds escape characters to POST)
echo '
defaultMapData = ['.$stripped_request.'
