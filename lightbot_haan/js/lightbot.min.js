...
title:"Το παιδί της μαμάς",message:"Κερδίστε χρυσό μετάλλιο.",check:function(){return lightBot.bot.getNumberOfInstructions()<=lightBot.map.getMedals().gold?true:false}},{name:"lightbot_achievement_complete_levels_5",title:"Φιλόδοξος",message:"Ολοκληρώστε 5 επίπεδα.",check:function(){return a()>=5?true:false}},{name:"lightbot_achievement_complete_levels_10",title:"Αφοσιωμένος",message:"Ολοκληρώστε 10 επίπεδα.",check:function(){return a()>=10?true:false}},{name:"lightbot_achievement_complete_levels_15",title:"Εθισμένος",message:"Ολοκληρώστε 15 επίπεδα.",
check:function(){return a()>=15?true:false}},{name:"lightbot_achievement_complete_levels_bronze",title:"Σπασίκλας",message:"Κερδίστε χάλκινα μετάλλια σε όλα τα επίπεδα.",check:function(){return b(lightBot.medals.bronze)===lightBot.map.getNbrOfLevels()}},{name:"lightbot_achievement_complete_levels_silver",title:"Elite",message:"Κερδίστε ασημένια μετάλλια σε όλα τα επίπεδα.",check:function(){return b(lightBot.medals.silver)===lightBot.map.getNbrOfLevels()}},{name:"lightbot_achievement_complete_levels_gold",title:"H4X0R",message:"Κερδίστε χρυσά μετάλλια σε όλα τα επίπεδα.",
...
$(this).button("option",{label:"Έναρξη",icons:{primary:"ui-icon-play"}}).removeClass("ui-state-highlight");else{var a=lightBot.ui.editor.getInstructions($("#programContainer > div > ul > li"));lightBot.bot.queueInstructions(a);lightBot.bot.execute();$(this).button("option",{label:"Διακοπή",icons:{primary:"ui-icon-stop"}}).addClass("ui-state-highlight")}});$("#clearButton").button({icons:{primary:"ui-icon-document"}}).click(function(){$("#programContainer ul").empty();lightBot.ui.editor.saveProgram()});
