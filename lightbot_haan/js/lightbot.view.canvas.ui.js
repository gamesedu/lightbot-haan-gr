  ...
  var ui = {
    ...
    showGameScreen: function(level, hist) {
      ...
      if (localStorage.getItem('lightbot_program_level_' + level)) {
        ...
        $('#programContainer ul').append('<li class="ui-state-default placeholder"><p class="placeholder">ΤΡΑΒΗΞΤΕ ΤΙΣ ΟΔΗΓΙΕΣ ΕΔΩ</p></li>');
      }

      // reset the run button
      $('#runButton').button('option', {label: 'Έναρξη-Δοκιμή', icons: {primary: 'ui-icon-play'}}).removeClass('ui-state-highlight');
